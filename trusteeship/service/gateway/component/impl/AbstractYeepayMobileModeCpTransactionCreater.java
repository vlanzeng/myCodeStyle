...
import com.weilingtou.soa.internal.common.util.SysConfig;
 ...
 */
public abstract class AbstractYeepayMobileModeCpTransactionCreater extends AbstractYeepayGateWayResultCreator<RepayUserTransactionInfo> {
    @Override
    ...
    protected Map<String, String> createparamsMapMap(RepayUserTransactionInfo yeepayUserTransactionInfo) {
        ...
        map.put("jsonObj", JSON.toJSONString(params));
        return params;
    }
